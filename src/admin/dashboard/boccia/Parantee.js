      ...
      <Tab.Pane className="no-border">
          ...
          <div className="dashboard-flex">
            <p
              dangerouslySetInnerHTML={{
                __html: data.bocciaParantee.substring(0, 255) + "..."
              }}
            />
            <Button
              icon
        ...
        <div className="dashboard-item">
          ...
          <div className="dashboard-flex">
            <p
              dangerouslySetInnerHTML={{
                __html: data.paranteeHistory.substring(0, 255) + "..."
              }}
            />
            <Button
              icon
...
export default connect(mapStateToProps, mapDispatchToProps)(Parantee);
