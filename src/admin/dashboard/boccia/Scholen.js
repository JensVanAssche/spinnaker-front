          ...
          <div className="dashboard-flex">
            <p
              dangerouslySetInnerHTML={{
                __html: data.bocciaScholen.substring(0, 255) + "..."
              }}
            />
            <Button
              icon
        ...
        <div className="dashboard-item">
          <div className="dashboard-flex">
            ...
            <Button
              ...
              className="small-button"
              onClick={() =>
                openPlayerModal("Scholen Speler toevoegen", null, "scholen")
              }
            >
              <span>Speler</span>
              <Icon name="add" />
              ...
              <Grid.Row key={player.id}>
                ...
                <Grid.Column width={7} className="grid-button">
                  <Button
                    ...
                    className="small-button"
                    onClick={() =>
                      openPlayerModal("Scholen Speler aanpassen", player, null)
                    }
                  >
                    <Icon name="edit" />
                  </Button>
        ...
        <div className="dashboard-item">
          <div className="dashboard-flex">
            ...
            <Button
              ...
              onClick={() =>
                openKalenderModal(
                  "Scholen Kalender Item toevoegen",
                  null,
                  "scholen"
                )
              }
...
export default connect(mapStateToProps, mapDispatchToProps)(Scholen);
