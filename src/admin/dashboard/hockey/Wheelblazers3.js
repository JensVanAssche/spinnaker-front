        ...
        <div className="dashboard-item">
          <div className="dashboard-flex">
            ...
            <Button
              ...
              onClick={() =>
                openPlayerModal(
                  "Wheelblazers 3 Speler toevoegen",
                  null,
                  "blazers3"
                )
              }
              ...
              <Grid.Row key={player.id}>
                ...
                <Grid.Column width={7} className="grid-button">
                  <Button
                    ...
                    onClick={() =>
                      openPlayerModal(
                        "Wheelblazers 3 Speler aanpassen",
                        player,
                        null
                      )
                    }
        ...
        <div className="dashboard-item">
          <div className="dashboard-flex">
            ...
            <Button
              ...
              onClick={() =>
                openResultTournamentModal(
                  "Wheelblazers 3 Tornooi toevoegen",
                  null,
                  "blazers3"
                )
              }
            ...
            <div key={result.id} className="scores-grid">
              <div className="scores-header">
                ...
                <Button
                  ...
                  onClick={() =>
                    openResultTournamentModal(
                      "Wheelblazers 3 Tornooi aanpassen",
                      result,
                      null
                    )
                  }
              ...
              <div className="scores-content">
                {result.scores.map(score => (
                  <div key={score.id} className="scores-content-entry">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        openResultScoreModal(
                          "Wheelblazers 3 Resultaat aanpassen",
                          score,
                          null
                        )
                      }
                ...
                <div className="scores-content-entry">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      openResultScoreModal(
                        "Wheelblazers 3 Resultaat toevoegen",
                        null,
                        result.id
                      )
                    }
              ...
              <div className="scores-content">
                {stand.scores.map(score => (
                  <div key={score.id} className="scores-content-entry">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        openStandingsScoreModal(
                          "Wheelblazers 3 Stand aanpassen",
                          score,
                          null,
                          true
                        )
                ...
                <div className="scores-content-entry">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      openStandingsScoreModal(
                        "Wheelblazers 3 Stand toevoegen",
                        null,
                        stand.id,
                        true
                      )
...
export default connect(mapStateToProps, mapDispatchToProps)(Wheelblazers3);
