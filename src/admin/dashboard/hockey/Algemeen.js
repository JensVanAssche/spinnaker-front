      ...
      <Tab.Pane className="no-border">
        ...
        <div className="dashboard-item">
          ...
          <div className="dashboard-flex">
            ...
            <Button
              ...
              onClick={() =>
                openFileModal("Hockey Foto", "content/data/hockeyImg")
              }
            >
              <Icon name="edit" />
            </Button>
          ...
          <div className="dashboard-flex">
            <p
              dangerouslySetInnerHTML={{
                __html: data.hockeyOver.substring(0, 255) + "..."
              }}
            />
            <Button
              icon
        ...
        <div className="dashboard-item">
          <div className="dashboard-flex">
            ...
            <Button
              ...
              onClick={() =>
                openKalenderModal(
                  "Hockey Kalender Item toevoegen",
                  null,
                  "hockey"
                )
              }
              ...
              <Grid.Row key={entry.id}>
                ...
                <Grid.Column width={2} className="grid-button">
                  <Button
                    ...
                    onClick={() =>
                      openKalenderModal(
                        "Hockey Kalender Item aanpassen",
                        entry,
                        null
                      )
                    }
        ...
        <div className="dashboard-item">
          ...
          <div className="dashboard-flex">
            <p
              dangerouslySetInnerHTML={{
                __html: data.hockeyHistory.substring(0, 255) + "..."
              }}
            />
            <Button
              icon
...
export default connect(mapStateToProps, mapDispatchToProps)(Algemeen);
