    ...
    return <Tab.Pane className="no-border">
      ...
      <div className="dashboard-item">
        <div className="dashboard-flex">
          ...
          <Button icon primary className="small-button" onClick={() => openPlayerModal('Wheelblazers 4 Speler toevoegen', null, 'blazers4')}>
            <span>Speler</span>
            <Icon name="add" />
          </Button>
        </div>
          ...
          {players.map(player => (
            <Grid.Row key={player.id}>
              ...
              <Grid.Column width={7} className="grid-button">
                <Button icon className="small-button" onClick={() => openPlayerModal('Wheelblazers 4 Speler aanpassen', player, null)}>
                  <Icon name="edit" />
                </Button>
              </Grid.Column>
            </Grid.Row>
      ...
      <div className="dashboard-item">
        <div className="dashboard-flex">
          ...
          <Button icon primary className="small-button" onClick={() => openResultTournamentModal('Wheelblazers 4 Tornooi toevoegen', null, 'blazers4')}>
        ...
        {results.map(result => (
          <div key={result.id} className="scores-grid">
            <div className="scores-header">
              ...
              <Button icon className="small-button" onClick={() => openResultTournamentModal('Wheelblazers 4 Tornooi aanpassen', result, null)}>
                <Icon name="edit" />
              </Button>
            </div>
            <div className="scores-content">
              {result.scores.map(score => (
                <div key={score.id} className="scores-content-entry">
                  ...
                  <Button icon className="small-button" onClick={() => openResultScoreModal('Wheelblazers 4 Resultaat aanpassen', score, null)}>
                    <Icon name="edit" />
                  </Button>
                </div>
              ))}
              <div className="scores-content-entry">
                <div />
                <Button icon primary className="small-button" onClick={() => openResultScoreModal('Wheelblazers 4 Resultaat toevoegen', null, result.id)}>
                  <Icon name="add" />
                </Button>
              </div>
            </div>
      ...
      <div className="dashboard-item">
        <div className="dashboard-flex">
          ...
          <Button icon primary className="small-button" onClick={() => openStandingsTournamentModal('Wheelblazers 4 Tornooi toevoegen', null, 'blazers4')} >
        ...
        {standings.map(stand => (
          <div key={stand.id} className="scores-grid">
            <div className="scores-header">
              ...
              <Button icon className="small-button" onClick={() => openStandingsTournamentModal('Wheelblazers 4 Tornooi aanpassen', stand, null)}>
                <Icon name="edit" />
              </Button>
            </div>
            <div className="scores-content">
              {stand.scores.map(score => (
                <div key={score.id} className="scores-content-entry">
                  ...
                  <Button icon className="small-button" onClick={() => openStandingsScoreModal('Wheelblazers 4 Stand aanpassen', score, null, true)}>
                    <Icon name="edit" />
                  </Button>
                </div>
              ))}
              <div className="scores-content-entry">
                <div />
                <Button icon primary className="small-button" onClick={() => openStandingsScoreModal('Wheelblazers 4 Stand toevoegen', null, stand.id, true)}>
                  <Icon name="add" />
                </Button>
              </div>
            </div>
