    ...
    return <Tab.Pane className="no-border">
      ...
      <div className="dashboard-item">
        <div className="dashboard-flex">
          ...
          <Button icon primary className="small-button" onClick={() => openPlayerModal('Hockey Nederland Speler toevoegen', null, 'hockeynederland')}>
            <span>Speler</span>
            <Icon name="add" />
          </Button>
        </div>
          ...
          {players.map(player => (
            <Grid.Row key={player.id}>
              ...
              <Grid.Column width={7} className="grid-button">
                <Button icon className="small-button" onClick={() => openPlayerModal('Hockey Nederland Speler aanpassen', player, null)}>
                  <Icon name="edit" />
                </Button>
              </Grid.Column>
            </Grid.Row>
      ...
      <div className="dashboard-item">
        <div className="dashboard-flex">
          ...
          <Button icon primary className="small-button" onClick={() => openResultTournamentModal('Hockey Nederland Tornooi toevoegen', null, 'hockeynederland')}>
        ...
        {results.map(result => (
          <div key={result.id} className="scores-grid">
            <div className="scores-header">
              ...
              <Button icon className="small-button" onClick={() => openResultTournamentModal('Hockey Nederland Tornooi aanpassen', result, null)}>
                <Icon name="edit" />
              </Button>
            </div>
            <div className="scores-content">
              {result.scores.map(score => (
                <div key={score.id} className="scores-content-entry">
                  ...
                  <Button icon className="small-button" onClick={() => openResultScoreModal('Hockey Nederland Resultaat aanpassen', score, null)}>
                    <Icon name="edit" />
                  </Button>
                </div>
              ))}
              <div className="scores-content-entry">
                <div />
                <Button icon primary className="small-button" onClick={() => openResultScoreModal('Hockey Nederland Resultaat toevoegen', null, result.id)}>
                  <Icon name="add" />
                </Button>
              </div>
            </div>
      ...
      <div className="dashboard-item">
        <div className="dashboard-flex">
          ...
          <Button icon primary className="small-button" onClick={() => openStandingsTournamentModal('Hockey Nederland Tornooi toevoegen', null, 'hockeynederland')} >
        ...
        {standings.map(stand => (
          <div key={stand.id} className="scores-grid">
            <div className="scores-header">
              ...
              <Button icon className="small-button" onClick={() => openStandingsTournamentModal('Hockey Nederland Tornooi aanpassen', stand, null)}>
                <Icon name="edit" />
              </Button>
            </div>
            <div className="scores-content">
              {stand.scores.map(score => (
                <div key={score.id} className="scores-content-entry">
                  ...
                  <Button icon className="small-button" onClick={() => openStandingsScoreModal('Hockey Nederland Stand aanpassen', score, null, true)}>
                    <Icon name="edit" />
                  </Button>
                </div>
              ))}
              <div className="scores-content-entry">
                <div />
                <Button icon primary className="small-button" onClick={() => openStandingsScoreModal('Hockey Nederland Stand toevoegen', null, stand.id, true)}>
                  <Icon name="add" />
                </Button>
              </div>
            </div>
