        ...
        <div className="dashboard-item small">
          <div className="dashboard-flex">
            ...
            <Button
              ...
              onClick={() => openArtikelModal("Artikel toevoegen")}
            >
              <span>Artikel</span>
              <Icon name="add" />
            </Button>
            ...
            <div className="dashboard-item" key={artikel.id}>
              <div className="dashboard-flex">
                <div>
                  ...
                  {artikel.image && (
                    <img
                      src={process.env.REACT_APP_API_HOST + artikel.image}
                      alt="artikel foto"
                    />
                  )}
                  <p
                    dangerouslySetInnerHTML={{
                      __html: artikel.body.substring(0, 255) + "..."
                    }}
                  />
                </div>
                <Button
                  icon
                  className="small-button"
                  onClick={() => openArtikelModal("Artikel aanpassen", artikel)}
                >
                  <Icon name="edit" />
                </Button>
              </div>
