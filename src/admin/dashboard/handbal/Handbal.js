      ...
      <Tab.Pane>
        ...
        <div className="dashboard-item">
          ...
          <div className="dashboard-flex">
            <img
              src={process.env.REACT_APP_API_HOST + data.handbalImg}
              alt="eumm"
            />
            <Button
              icon
              ...
              onClick={() =>
                openFileModal("Handbal Foto", "content/data/handbalImg")
              }
            >
              <Icon name="edit" />
            </Button>
          ...
          <div className="dashboard-flex">
            <p
              dangerouslySetInnerHTML={{
                __html: data.handbalOver.substring(0, 255) + "..."
              }}
            />
            <Button
              icon
        ...
        <div className="dashboard-item">
          <div className="dashboard-flex">
            ...
            <Button
              ...
              onClick={() =>
                openKalenderModal(
                  "Handbal Kalender Item toevoegen",
                  null,
                  "handbal"
                )
              }
              ...
              <Grid.Row key={entry.id}>
                ...
                <Grid.Column width={2} className="grid-button">
                  <Button
                    ...
                    onClick={() =>
                      openKalenderModal(
                        "Handbal Kalender Item aanpassen",
                        entry,
                        null
                      )
                    }
...
export default connect(mapStateToProps, mapDispatchToProps)(Handbal);
