      ...
      <div className="competitie">
        <nav className="subsubnav">
          ...
          <ul className="ui container">
            <li>
              <NavLink exact={true} to={match.path}>
                {this.state.league[league]}
              </NavLink>
            </li>
            <li>
              <NavLink to={`${match.path}/spelers`}>spelers</NavLink>
            </li>
            <li>
              <NavLink to={`${match.path}/kalender`}>kalender</NavLink>
            </li>
            <li>
              <NavLink to={`${match.path}/resultaten`}>resultaten</NavLink>
            </li>
            <li>
              <NavLink to={`${match.path}/stand`}>stand</NavLink>
            </li>
            {league !== 1 && (
              <li>
        ...
        <div className="ui container content">
          <Switch>
            <Route
              ...
              path={match.path}
              component={props => (
                <CompetitieIndex league={league} {...props} />
              )}
            />
            <Route
              exact
              path={`${match.path}/spelers`}
              component={props => (
                <CompetitieSpelers league={league} {...props} />
              )}
            />
            <Route
              exact
              ...
              component={props => (
                <CompetitieKalender league={league} {...props} />
              )}
            />
            <Route
              exact
              path={`${match.path}/resultaten`}
              component={props => (
                <CompetitieResultaten league={league} {...props} />
              )}
            />
            <Route
              exact
              path={`${match.path}/stand`}
              component={props => (
                <CompetitieStand league={league} {...props} />
              )}
            />
            {league !== 1 && (
              <Route
                ...
                component={props => (
                  <CompetitieHistoriek league={league} {...props} />
                )}
              />
            )}
