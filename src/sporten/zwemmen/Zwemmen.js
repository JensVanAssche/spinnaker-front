    ...
    <div className="Zwemmen">
      <nav className="subnav">
        ...
        <ul className="ui container">
          <li onClick={() => onNavigationClick()}><NavLink to={match.path} exact={true}>ZWEMMEN</NavLink></li>
          <li onClick={() => onNavigationClick()}><NavLink to={`${match.path}/kalender`}>zwemmen kalender</NavLink></li>
        </ul>
      </nav>
