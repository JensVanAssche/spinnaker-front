        ...
        <div className="ui container content">
          <Switch>
            <Route exact path={match.path}>
              <Redirect to={{ pathname: `${match.path}/spelers` }} />
            </Route>
            <Route
              exact
              path={`${match.path}/spelers`}
              component={props => <TeamSpelers team={team} {...props} />}
            />
            <Route
              exact
              path={`${match.path}/resultaten`}
              component={props => <TeamResultaten team={team} {...props} />}
            />
            <Route
              exact
              path={`${match.path}/stand`}
              component={props => <TeamStand team={team} {...props} />}
            />
